    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 예약 버튼 클릭 시 동작
                if (equipment.getStatus().equals("이용할 수 있음")) {
                    // 예약 가능한 기구일 경우 동작
                    equipment.setStatus("예약됨");
                    notifyDataSetChanged();
                    Toast.makeText(context, "예약되었습니다.", Toast.LENGTH_SHORT).show();
                } else {
                    // 예약 불가능한 기구일 경우 동작
                    Toast.makeText(context, "이미 예약된 기구입니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        holder.buttonCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 예약 취소 버튼 클릭 시 동작
                if (equipment.getStatus().equals("예약됨")) {
                    // 예약된 기구일 경우 동작
                    ...
                    // 예약되지 않은 기구일 경우 동작
                    Toast.makeText(context, "예약된 기구가 아닙니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
